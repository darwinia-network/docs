...
!!! note
    This tutorial is based on the [Darwinia network](../../build/getting-started/networks/darwinia.md), and the same operations apply to other chains.
...
- By default, the MetaMask extension is connected to the Ethereum Mainnet. So, you need to switch from the Ethereum Mainnet to the Darwinia network. The [network information page](../../build/getting-started/networks/darwinia.md#connect-wallet-automatically) provides a convenient link to connect directly.

    ![evm-tutorial-token-transfer-3](../../images/evm-tutorial-token-transfer-3.png)
    
Click the `Connect` button, and the MetaMask extension will automatically switch to the Darwinia network. Check the network displayed and click the `Approve` button. Then , you can see that the network has switched from the Ethereum Mainnet to Darwinia.
...
`Test Account 1` has 20 RING and `Test Account 2` balance is 0. Let's transfer 10 RING to the `Test Account 2` next.
